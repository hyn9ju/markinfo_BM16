/* ============================================================
   MBCI (Markinfo Brand Core Indicator) — 애플리케이션
...
/* v0.20.0: 기존 스타일 매트릭스 12문항은 MBCI 12문항으로 교체되었다.
   위의 AXES(G/L·B/S·E/R·C/M)는 「직접 조절하기」 슬라이더 전용으로 그대로 남긴다. */
const MBCI_DEFAULT={"version": 1, "codeOrder": ["EI", "SN", "TF", "JP"], "settings": {"neutralEnabled": true, "neutralLabel": "둘 다 애매해요", "tiePolicy": "manual", "minWeight": 0, "maxWeight": 3}, "axes": [{"id": "EI", "order": 1, "name": "표현 에너지", "left": {"code": "E", "label": "Expressive", "description": "강렬하고 적극적인 존재감"}, "right": {"code": "I", "label": "Intimate", "description": "절제되고 섬세한 인상"}}, {"id": "SN", "order": 2, "name": "표현 방식", "left": {"code": "S", "label": "Specific", "description": "직관적이고 구체적인 형태"}, "right": {"code": "N", "label": "Narrative", "description": "상징적이고 서사적인 형태"}}, {"id": "TF", "order": 3, "name": "감성 온도", "left": {"code": "T", "label": "Technical", "description": "논리적이고 기하학적인 구조"}, "right": {"code": "F", "label": "Feeling", "description": "따뜻하고 유기적인 감성"}}, {"id": "JP", "order": 4, "name": "조형 질서", "left": {"code": "J", "label": "Justified", "description": "정돈된 규칙과 일관성"}, "right": {"code": "P", "label": "Playful", "description": "자유로운 변주와 유연성"}}], "questions": [{"id": "q01", "order": 1, "active": true, "axisId": "EI", "text": "우리 브랜드의 로고를 처음 본 사람이 어떤 인상을 받았으면 하나요?", "memo": "", "answers": [{"id": "A", "text": "한눈에 시선을 끌고 강한 인상을 남겼으면 좋겠다.", "pole": "E", "weight": 1, "image": {"src": "", "alt": "", "fit": "contain", "position": "center", "sourceNote": ""}}, {"id": "B", "text": "과하게 드러내기보다 은은하고 세련된 인상을 남겼으면 좋겠다.", "pole": "I", "weight": 1, "image": {"src": "", "alt": "", "fit": "contain", "position": "center", "sourceNote": ""}}]}, {"id": "q02", "order": 2, "active": true, "axisId": "EI", "text": "로고에서 컬러를 사용한다면 어떤 방식이 더 마음에 드나요?", "memo": "", "answers": [{"id": "A", "text": "선명하고 대비가 강한 컬러로 존재감을 드러내는 방식", "pole": "E", "weight": 1, "image": {"src": "", "alt": "", "fit": "contain", "position": "center", "sourceNote": ""}}, {"id": "B", "text": "절제된 컬러와 톤으로 편안한 분위기를 만드는 방식", "pole": "I", "weight": 1, "image": {"src": "", "alt": "", "fit": "contain", "position": "center", "sourceNote": ""}}]}, {"id": "q03", "order": 3, "active": true, "axisId": "EI", "text": "두 가지 로고 중 우리 브랜드에 더 어울리는 것은 무엇인가요?", "memo": "", "answers": [{"id": "A", "text": "크고 굵은 형태처럼 멀리서도 눈에 띄는 로고", "pole": "E", "weight": 1, "image": {"src": "", "alt": "", "fit": "contain", "position": "center", "sourceNote": ""}}, {"id": "B", "text": "여백과 섬세한 디테일처럼 가까이 볼수록 매력이 느껴지는 로고", "pole": "I", "weight": 1, "image": {"src": "", "alt": "", "fit": "contain", "position": "center", "sourceNote": ""}}]}, {"id": "q04", "order": 4, "active": true, "axisId": "SN", "text": "로고를 처음 보는 사람이 브랜드를 어떻게 이해했으면 하나요?", "memo": "", "answers": [{"id": "A", "text": "어떤 브랜드인지 비교적 빠르고 쉽게 알아볼 수 있었으면 좋겠다.", "pole": "S", "weight": 1, "image": {"src": "", "alt": "", "fit": "contain", "position": "center", "sourceNote": ""}}, {"id": "B", "text": "처음에는 궁금증을 느끼고, 의미를 알아갈수록 인상적이면 좋겠다.", "pole": "N", "weight": 1, "image": {"src": "", "alt": "", "fit": "contain", "position": "center", "sourceNote": ""}}]}, {"id": "q05", "order": 5, "active": true, "axisId": "SN", "text": "브랜드의 특징을 로고에 담는다면 어떤 방식이 더 좋나요?", "memo": "", "answers": [{"id": "A", "text": "제품·서비스·이름의 특징을 알아볼 수 있는 형태로 표현한다.", "pole": "S", "weight": 1, "image": {"src": "", "alt": "", "fit": "contain", "position": "center", "sourceNote": ""}}, {"id": "B", "text": "브랜드가 가진 가치나 이야기를 상징적인 형태로 표현한다.", "pole": "N", "weight": 1, "image": {"src": "", "alt": "", "fit": "contain", "position": "center", "sourceNote": ""}}]}, {"id": "q06", "order": 6, "active": true, "axisId": "SN", "text": "심볼을 만든다면 어느 쪽에 더 끌리나요?", "memo": "", "answers": [{"id": "A", "text": "의미가 명확하게 읽히는 아이콘이나 구체적인 형태", "pole": "S", "weight": 1, "image": {"src": "", "alt": "", "fit": "contain", "position": "center", "sourceNote": ""}}, {"id": "B", "text": "여러 의미를 떠올릴 수 있는 추상적이고 독창적인 형태", "pole": "N", "weight": 1, "image": {"src": "", "alt": "", "fit": "contain", "position": "center", "sourceNote": ""}}]}, {"id": "q07", "order": 7, "active": true, "axisId": "TF", "text": "우리 브랜드가 가장 먼저 전달하고 싶은 이미지는 무엇에 가까운가요?", "memo": "", "answers": [{"id": "A", "text": "전문적이고 정확하며 믿을 수 있는 이미지", "pole": "T", "weight": 1, "image": {"src": "", "alt": "", "fit": "contain", "position": "center", "sourceNote": ""}}, {"id": "B", "text": "친근하고 따뜻하며 공감할 수 있는 이미지", "pole": "F", "weight": 1, "image": {"src": "", "alt": "", "fit": "contain", "position": "center", "sourceNote": ""}}]}, {"id": "q08", "order": 8, "active": true, "axisId": "TF", "text": "로고의 형태를 고른다면 어느 쪽이 더 마음에 드나요?", "memo": "", "answers": [{"id": "A", "text": "직선과 기하학적 도형처럼 명확하고 계산된 형태", "pole": "T", "weight": 1, "image": {"src": "", "alt": "", "fit": "contain", "position": "center", "sourceNote": ""}}, {"id": "B", "text": "곡선과 자연스러운 선처럼 부드럽고 인간적인 형태", "pole": "F", "weight": 1, "image": {"src": "", "alt": "", "fit": "contain", "position": "center", "sourceNote": ""}}]}, {"id": "q09", "order": 9, "active": true, "axisId": "TF", "text": "글자 로고를 만든다면 어떤 스타일에 더 끌리나요?", "memo": "", "answers": [{"id": "A", "text": "군더더기 없이 깔끔하고 체계적으로 정돈된 글자", "pole": "T", "weight": 1, "image": {"src": "", "alt": "", "fit": "contain", "position": "center", "sourceNote": ""}}, {"id": "B", "text": "개성과 감정이 느껴지는 부드럽거나 특징적인 글자", "pole": "F", "weight": 1, "image": {"src": "", "alt": "", "fit": "contain", "position": "center", "sourceNote": ""}}]}, {"id": "q10", "order": 10, "active": true, "axisId": "JP", "text": "우리 브랜드의 로고는 어떤 모습으로 활용되는 것이 좋나요?", "memo": "", "answers": [{"id": "A", "text": "어디에서 사용해도 동일한 형태와 규칙을 유지했으면 좋겠다.", "pole": "J", "weight": 1, "image": {"src": "", "alt": "", "fit": "contain", "position": "center", "sourceNote": ""}}, {"id": "B", "text": "상황과 콘텐츠에 따라 형태가 유연하게 변할 수 있으면 좋겠다.", "pole": "P", "weight": 1, "image": {"src": "", "alt": "", "fit": "contain", "position": "center", "sourceNote": ""}}]}, {"id": "q11", "order": 11, "active": true, "axisId": "JP", "text": "로고의 전체적인 구도는 어느 쪽이 더 마음에 드나요?", "memo": "", "answers": [{"id": "A", "text": "좌우 균형과 정렬이 잘 맞는 안정적이고 완성된 구도", "pole": "J", "weight": 1, "image": {"src": "", "alt": "", "fit": "contain", "position": "center", "sourceNote": ""}}, {"id": "B", "text": "비대칭이나 예상 밖의 배치가 있는 자유롭고 생동감 있는 구도", "pole": "P", "weight": 1, "image": {"src": "", "alt": "", "fit": "contain", "position": "center", "sourceNote": ""}}]}, {"id": "q12", "order": 12, "active": true, "axisId": "JP", "text": "브랜드 디자인을 운영할 때 더 중요하다고 생각하는 것은 무엇인가요?", "memo": "", "answers": [{"id": "A", "text": "명확한 규칙을 만들어 모든 디자인에 일관되게 적용하는 것", "pole": "J", "weight": 1, "image": {"src": "", "alt": "", "fit": "contain", "position": "center", "sourceNote": ""}}, {"id": "B", "text": "기본적인 개성만 유지하면서 상황에 따라 다양하게 변주하는 것", "pole": "P", "weight": 1, "image": {"src": "", "alt": "", "fit": "contain", "position": "center", "sourceNote": ""}}]}]};
/* MBCI_TEST는 bsm-data.js가 단일 원본이다. 예전 데이터 파일에 없으면 내장 기본 12문항을 쓴다. */
if(!BSM_DATA.MBCI_TEST||mbciSchemaErrors(BSM_DATA.MBCI_TEST).length){
  if(BSM_DATA.MBCI_TEST)console.warn('[MBCI] 데이터 형식 오류 — 내장 기본 문항으로 대체합니다',mbciSchemaErrors(BSM_DATA.MBCI_TEST));
  BSM_DATA.MBCI_TEST=JSON.parse(JSON.stringify(MBCI_DEFAULT));
}
const MBCI=BSM_DATA.MBCI_TEST;
/* 불러오기 전 구조 검증 — 치명적 오류만 반환한다 (운영 경고는 validateMbci에서) */
function mbciSchemaErrors(m){
  const e=[];
  if(!m||typeof m!=='object')return['MBCI_TEST가 객체가 아닙니다'];
  if(!Array.isArray(m.axes)||!m.axes.length)e.push('axes가 비어 있습니다');
  if(!Array.isArray(m.questions)||!m.questions.length)e.push('questions가 비어 있습니다');
  (m.axes||[]).forEach((a,i)=>{if(!a||!a.id||!a.left||!a.right||!a.left.code||!a.right.code)e.push(`axes[${i}] 형식 오류`);});
  (m.questions||[]).forEach((q,i)=>{
    if(!q||!q.id||!q.axisId||!Array.isArray(q.answers)||q.answers.length!==2)e.push(`questions[${i}] 형식 오류`);
  });
  return e;
}
...
let qIdx=0, qAns={};          // qAns: {questionId: 'A'|'B'|'N'}
let mbciResult=null, mbciTieFix={};   // 동점 축을 사용자가 직접 고른 값
...
/* ================= SLIDERS UI ================= */
function buildAxes(){
  const box=$('axes'); if(!box)return;   // v2.1.0: 직접 조절하기 삭제로 #axes가 더 이상 없다
...
function axisState(i){
  if(!sliders[i])return {side:null,strength:null,v:3};   // v2.1.0: 슬라이더가 없으면 항상 '미정'
...
/* ================= MBCI TEST (v0.20.0) =================
   12개 질문 → 4개 축 점수 → 4자리 브랜드 코어 코드.
   답변의 A/B 글자는 점수 방향이 아니다 — 각 답변의 pole이 실제 점수 대상이다. */
const Q_PLACEHOLDER='assets/img/questions/placeholder.webp';
function mbciAxes(){return MBCI.axes.slice().sort((a,b)=>a.order-b.order);}
function mbciAxis(id){return MBCI.axes.find(a=>a.id===id);}
function mbciQs(){return MBCI.questions.filter(q=>q.active!==false).sort((a,b)=>a.order-b.order);}
function esc(t){return String(t==null?'':t).replace(/&/g,'&amp;').replace(/</g,'&lt;').replace(/>/g,'&gt;').replace(/"/g,'&quot;');}

/* 채점 — answers: {questionId:'A'|'B'|'N'} , qs: 채점 대상 문항 */
function scoreMbci(answers,qs){
  qs=qs||mbciQs();
  const scores={};
  MBCI.axes.forEach(a=>{scores[a.left.code]=0;scores[a.right.code]=0;});
  qs.forEach(q=>{
    const pick=answers[q.id]; if(pick!=='A'&&pick!=='B')return;   // 중립·건너뛰기는 0점
    const an=q.answers.find(x=>x.id===pick); if(!an||!an.pole)return;
    scores[an.pole]=(scores[an.pole]||0)+(+an.weight||0);
  });
  const axisResult={}, ties=[], confidence={};
  mbciAxes().forEach(a=>{
    const L=scores[a.left.code]||0, R=scores[a.right.code]||0;
    if(L>R)axisResult[a.id]=a.left.code;
    else if(R>L)axisResult[a.id]=a.right.code;
    else{axisResult[a.id]=null;ties.push(a.id);}
    confidence[a.id]=(L+R)?Math.abs(L-R)/(L+R):0;
  });
  const order=MBCI.codeOrder||mbciAxes().map(a=>a.id);
  const resultCode=ties.length?null:order.map(id=>axisResult[id]).join('');
  return {resultCode,axisResult,scores,ties,confidence};
}
function imgFor(an){return (an.image&&an.image.src)||'';}

/* 선택지 카드 — 라벨(A/B) → 이미지 → 답변 문구. 문구는 textContent 성격으로만 출력한다 */
function mbciOptionHTML(q,an,selected){
  const im=an.image||{}, src=imgFor(an);
  return `<button type="button" class="mb-opt${selected?' on':''}" data-ans="${an.id}" aria-pressed="${selected?'true':'false'}">
    <span class="mb-lab">${esc(an.id)}</span>
    <span class="mb-img"><img src="${esc(src||Q_PLACEHOLDER)}" alt="${esc(src?(im.alt||an.text):'')}"
      style="object-fit:${im.fit==='cover'?'cover':'contain'};object-position:${esc(im.position||'center')}"
      onerror="if(!this.dataset.fb){this.dataset.fb=1;this.src='${Q_PLACEHOLDER}';this.alt='';}"></span>
    <span class="mb-txt">${esc(an.text)}</span>
    <span class="mb-chk" aria-hidden="true"></span>
  </button>`;
}
function mbciQuestionHTML(q,idx,total,sel){
  const ax=mbciAxis(q.axisId);
  return `<div class="progress"><i style="width:${(idx/total*100).toFixed(1)}%"></i></div>
    <div class="qno">질문 ${idx+1} / ${total}${ax?` · ${esc(ax.name)}`:''}</div>
    <div class="qtext">${esc(q.text)}</div>
    <div class="mb-opts">${q.answers.map(an=>mbciOptionHTML(q,an,sel===an.id)).join('')}</div>`;
}
function renderQ(){
  const qs=mbciQs(), stage=$('qStage'), res=$('mbciGauges');
  if(!stage)return;
  stage.classList.remove('hidden'); if(res)res.classList.add('hidden');
  if(!qs.length){stage.innerHTML='<p class="mb-empty">활성화된 질문이 없습니다 — 관리자에서 질문을 켜 주세요.</p>';return;}
  qIdx=Math.max(0,Math.min(qIdx,qs.length-1));
  const q=qs[qIdx];
  const st=MBCI.settings||{};
  stage.innerHTML=mbciQuestionHTML(q,qIdx,qs.length,qAns[q.id])
    +(st.neutralEnabled!==false?`<button type="button" class="opt opt-skip mb-neutral" data-ans="N">${esc(st.neutralLabel||'둘 다 애매해요')}</button>`:'')
    +`<div class="qnav"><button type="button" id="qPrev" style="visibility:${qIdx===0?'hidden':'visible'}">← 이전 질문</button><span></span></div>`;
  stage.querySelectorAll('[data-ans]').forEach(b=>b.onclick=()=>answer(b.dataset.ans));
  const pv=$('qPrev'); if(pv)pv.onclick=()=>{if(qIdx>0){qIdx--;renderQ();}};
}
function answer(ansId){
  const qs=mbciQs(), q=qs[qIdx]; if(!q)return;
  qAns[q.id]=ansId;
  const card=$('qStage').querySelector(`[data-ans="${ansId}"]`);
  if(card)card.classList.add('on');
  setTimeout(()=>{ if(qIdx<qs.length-1){qIdx++;renderQ();} else finishQ(); },180);
}
function resetQ(){qIdx=0;qAns={};mbciResult=null;mbciTieFix={};}
function finishQ(){
  mbciResult=scoreMbci(qAns);
  mbciTieFix={};
  renderMbciResult();
}
/* v2.1.0: 결과를 두 칸으로 나눈다 — 왼쪽(옛 질문 자리)은 4개 축 게이지를 읽기 전용으로 보여주고
   (가중치가 어디로 흘렀는지 확인용, 손잡이는 없다), 오른쪽(#result)은 브랜드 코어 이름·설명이다. */
function renderMbciResult(){
  const r=mbciResult; if(!r)return;
  const stage=$('qStage'), gauges=$('mbciGauges');
  stage.classList.add('hidden'); gauges.classList.remove('hidden');
  const axRes={...r.axisResult,...mbciTieFix};
  const pending=mbciAxes().filter(a=>!axRes[a.id]);
  const order=MBCI.codeOrder||mbciAxes().map(a=>a.id);
  const code=pending.length?null:order.map(id=>axRes[id]).join('');

  const rows=mbciAxes().map(a=>{
    const L=r.scores[a.left.code]||0, R=r.scores[a.right.code]||0, pick=axRes[a.id];
    const tied=!r.axisResult[a.id];
    const total=L+R, off=total?((L-R)/total)*50:0;   // 중앙(50%) 기준 좌우로 채워지는 오프셋
    const fillLeft=off>0, w=Math.abs(off);   // v2.2.0: 방향 버그 수정 — 왼쪽 극이 이기면(off>0) 왼쪽으로 채운다
    return `<div class="mb-gauge${tied?' tie':''}">
      <div class="mb-gn">${esc(a.name)}</div>
      <div class="mb-gpoles">
        <span class="${pick===a.left.code?'win':''}"><b>${esc(a.left.code)}</b> ${esc(a.left.label)}</span>
        <span class="${pick===a.right.code?'win':''}">${esc(a.right.label)} <b>${esc(a.right.code)}</b></span>
      </div>
      <div class="mb-gtrack"><i class="mb-gmid"></i><i class="mb-gfill" style="left:${fillLeft?(50-w):50}%;width:${w}%"></i></div>
      ${tied?`<div class="mb-tie">
          <p>이 축은 답변이 같아 정해지지 않았어요. 더 가까운 쪽을 직접 골라 주세요.</p>
          <div class="mb-tie-btns">
            <button type="button" data-fix="${a.id}:${a.left.code}" class="${pick===a.left.code?'on':''}">${esc(a.left.code)} · ${esc(a.left.description)}</button>
            <button type="button" data-fix="${a.id}:${a.right.code}" class="${pick===a.right.code?'on':''}">${esc(a.right.code)} · ${esc(a.right.description)}</button>
          </div></div>`
        :''}
    </div>`;}).join('');
  gauges.innerHTML=`<div class="mb-g-head"><b>${code?esc(code):order.map(id=>axRes[id]||'?').join('')}</b><span>답변이 각 축으로 어떻게 쌓였는지 보여줘요</span></div>
    <div class="mb-gauges-rows">${rows}</div>
    <div class="mb-r-acts"><button type="button" class="btn-line" id="mbRetry">다시 테스트하기</button></div>`;
  gauges.querySelectorAll('[data-fix]').forEach(b=>b.onclick=()=>{
    const [id,c]=b.dataset.fix.split(':'); mbciTieFix[id]=c; renderMbciResult();
  });
  $('mbRetry').onclick=()=>{resetQ();renderQ();window.scrollTo({top:0,behavior:'smooth'});};

  window.MBCI_LAST_RESULT={resultCode:code,axisResult:axRes,scores:r.scores};
  renderBrandCoreResult(code, order.map(id=>axRes[id]||'?').join(''));
  window.scrollTo({top:0,behavior:'smooth'});
}
/* v2.2.0: 오른쪽 패널 — legacyStyleCode 매핑이 있으면 기존 결과창(색상·폰트·목업·이미지·스튜디오)을
   그대로 복원해서 보여준다. 이름·설명은 이미 MBCI 값으로 데이터 이전을 마쳤으므로 renderStyle()을
   그대로 불러도 MBCI 이름이 나온다 — 코드 배지 두 곳(sc-code, cm-code)만 legacy 글자 대신 MBCI 코드로 바꿔 준다. */
function renderBrandCoreResult(code,partial){
  const box=$('result'); if(!box)return;
  if(!code){
    box.innerHTML=`<div class="placeholder">
      <div class="big">${esc(partial)}</div>
      <p>정해지지 않은 축이 있어요. 왼쪽에서 더 가까운 쪽을 골라 주세요.</p>
    </div>`;
    return;
  }
  const info=(MBCI.results||{})[code];
  const ax=mbciAxes(), order=MBCI.codeOrder||ax.map(a=>a.id);
  const letters=order.map(id=>{const a=mbciAxis(id), ch=code[order.indexOf(id)];
    return ch===a.left.code?a.left.label:a.right.label;}).join(' / ');
  if(!info){
    box.innerHTML=`<div class="mb-core">
      <div class="mb-core-code">${esc(code)}</div>
      <div class="mb-core-letters">${esc(letters)}</div>
      <p class="mb-core-empty">이 코드의 이름·설명이 아직 등록되지 않았어요 — 관리자 「결과」 탭에서 채울 수 있어요.</p>
    </div>`;
    return;
  }
  const legacy=info.legacyStyleCode;
  if(legacy&&STYLES[legacy]){
    curCode=legacy;
    curScheme=STYLES[legacy].scheme;
    curAnchor={h:null,s:null,b:null};
    curLocks=[false,false,false,false,false];
    curFontIdx=0; fontTypeFilter='전체';
    curPal=genPalette(STYLES[legacy],curScheme);
    renderStyle();   // 기존 결과창 전체(색상 조합·추천 글꼴·브랜드 목업·참고 이미지·디자인 스튜디오)를 그대로 그린다
    const scCode=box.querySelector('.sc-code'); if(scCode)scCode.textContent=code.split('').join(' · ');
    const cmCode=box.querySelector('.cm-code'); if(cmCode)cmCode.textContent=code.split('').join('·');
    if(info.mappingLevel==='needs_support'){
      const hero=box.querySelector('.sc-hero');
      if(hero&&!hero.querySelector('.mb-support-badge')){
        const b=document.createElement('div'); b.className='mb-support-badge';
        b.textContent='이 코어 전용 자산은 준비 중이에요 — 가장 가까운 기존 스타일을 보여드려요';
        hero.appendChild(b);
      }
    }
    return;
  }
  // legacy 매핑이 없으면(또는 자산 연결 전) 이름·설명만 보여주는 기본 카드로 대체
  box.innerHTML=`<div class="mb-core">
    <div class="mb-core-head">당신의 브랜드 코어는</div>
    <div class="mb-core-name">'${esc(info.name)}'<span class="mb-core-code">${esc(code)}</span></div>
    <div class="mb-core-letters">${esc(letters)}</div>
    <div class="mb-core-kw">${(info.keywords||[]).map(k=>`<span>${esc(k)}</span>`).join('')}</div>
    <p class="mb-core-desc">${esc(info.desc||'')}</p>
    <button type="button" class="btn-line" id="mbShare">결과 링크 복사</button>
  </div>`;
  const sb=$('mbShare');
  if(sb)sb.onclick=()=>{
    const url=location.origin+location.pathname+'#/core/'+code;
    navigator.clipboard?.writeText(url).then(()=>toast('결과 링크를 복사했어요')).catch(()=>toast(url));
  };
}

/* ================= 관리자 · MBCI 질문 관리 (v0.20.0) =================
   편집은 작업 사본(mqDraft)에서 하고 「이 문항 적용」으로 MBCI에 반영한다.
   문항 수는 12개 고정 — 순서·사용 여부·문구·축·극·가중치·이미지를 수정한다. */
let mqSel=null, mqDraft=null, mqSimAns={}, mqVw='d';
const MQ_MAX_BYTES=5*1024*1024, MQ_WARN_BYTES=500*1024, MQ_TYPES=['image/webp','image/png','image/jpeg'];

/* 전체 검증 — errors가 있으면 저장·내보내기 차단, warnings는 알림만 */
function validateMbci(m){
  m=m||MBCI;
  const errors=[], warnings=[], st=m.settings||{};
  const minW=st.minWeight??0, maxW=st.maxWeight??3;
  const act=m.questions.filter(q=>q.active!==false);
  const ids=act.map(q=>q.id);
  ids.filter((x,i)=>ids.indexOf(x)!==i).forEach(x=>errors.push(`문항 ID 중복: ${x}`));
  const axIds=m.axes.map(a=>a.id);
  const perAxis={}, maxPerAxis={};
  axIds.forEach(a=>{perAxis[a]=0;maxPerAxis[a]=0;});
  act.forEach(q=>{
    const tag=q.id;
    if(!String(q.text||'').trim())errors.push(`${tag}: 질문 문구가 비어 있음`);
    const ax=m.axes.find(a=>a.id===q.axisId);
    if(!ax){errors.push(`${tag}: 존재하지 않는 축 ${q.axisId}`);return;}
    perAxis[ax.id]++;
    const poles=[ax.left.code,ax.right.code];
    q.answers.forEach(an=>{
      if(!String(an.text||'').trim())errors.push(`${tag}-${an.id}: 답변 문구가 비어 있음`);
      if(!poles.includes(an.pole))errors.push(`${tag}-${an.id}: 극 ${an.pole}은(는) ${ax.id} 축에 속하지 않음`);
      const w=an.weight;
      if(typeof w!=='number'||!isFinite(w))errors.push(`${tag}-${an.id}: 가중치가 숫자가 아님`);
      else if(w<minW||w>maxW)errors.push(`${tag}-${an.id}: 가중치 ${w} — ${minW}~${maxW} 범위를 벗어남`);
      if(!an.image||!an.image.src)warnings.push(`${tag}-${an.id}: 이미지 없음 (자리표시 이미지로 표시)`);
      else if(!String(an.image.alt||'').trim())warnings.push(`${tag}-${an.id}: 대체 텍스트(alt) 없음 — 접근성`);
    });
    if(q.answers.length===2&&q.answers[0].pole===q.answers[1].pole)errors.push(`${tag}: A/B가 같은 극(${q.answers[0].pole})을 가리킴`);
    if(q.answers.length===2&&q.answers[0].weight!==q.answers[1].weight)warnings.push(`${tag}: A/B 가중치가 다름 — 결과가 한쪽으로 치우칠 수 있음`);
    maxPerAxis[ax.id]+=Math.max(...q.answers.map(a=>+a.weight||0));
  });
  axIds.forEach(a=>{
    if(!perAxis[a])errors.push(`${a} 축에 활성 문항이 없음`);
    else if(perAxis[a]%2===0)warnings.push(`${a} 축 활성 문항 ${perAxis[a]}개(짝수) — 동점 가능`);
  });
  const mx=Object.values(maxPerAxis), hi=Math.max(...mx), lo=Math.min(...mx);
  if(lo>0&&hi-lo>=2)warnings.push(`축별 최대 점수 차이 ${lo}~${hi} — 축 강도 비교가 왜곡될 수 있음`);
  return {errors,warnings};
}
function renderMbciCheck(){
  const v=validateMbci(), box=$('mqCheck'); if(!box)return v;
  const cnt=$('tabCntMbci'); if(cnt)cnt.textContent=`${mbciQs().length}문항${v.errors.length?` · 오류 ${v.errors.length}`:''}`;
  if(!v.errors.length&&!v.warnings.length){box.innerHTML='<div class="mq-ok">✓ 검증 통과 — 저장·내보내기 가능</div>';return v;}
  box.innerHTML=(v.errors.length?`<div class="mq-err"><b>오류 ${v.errors.length} — 해결 전에는 내보낼 수 없습니다</b><ul>${v.errors.map(x=>`<li>${esc(x)}</li>`).join('')}</ul></div>`:'')
    +(v.warnings.length?`<details class="mq-warn"><summary>경고 ${v.warnings.length}</summary><ul>${v.warnings.map(x=>`<li>${esc(x)}</li>`).join('')}</ul></details>`:'');
  return v;
}
/* ================= 관리자 · 결과 (v2.1.0) =================
   16개 브랜드 코어의 코드·이름·키워드·설명을 관리하는 마스터 페이지.
   코드 자체는 4개 축 조합으로 정해지므로 편집하지 않고, 이름·키워드·설명만 편집한다. */
function shareUrlFor(code){ return location.origin+location.pathname+'#/core/'+code; }
function renderAdminResults(){
  const box=$('rsList'); if(!box)return;
  const codes=allCoreCodes();
  const results=MBCI.results=MBCI.results||{};
  box.innerHTML=codes.map((code,i)=>{
    const v=results[code]||{code,name:'',keywords:[],desc:'',order:i};
    const done=v.name&&v.desc;
    return `<div class="rs-row${done?'':' rs-empty'}" data-code="${code}">
      <div class="rs-row-h">
        <span class="rs-code">${code}</span>
        <input class="af-in rs-name" data-code="${code}" data-f="name" value="${esc(v.name||'')}" placeholder="예: 시그널코어">
        <a class="rs-link" href="${esc(shareUrlFor(code))}" target="_blank" rel="noopener" title="이 결과 페이지 열기">링크 ↗</a>
        <button type="button" class="chip-btn rs-copy" data-code="${code}">복사</button>
      </div>
      <input class="af-in rs-kw" data-code="${code}" data-f="keywords" value="${esc((v.keywords||[]).join(', '))}" placeholder="키워드 3개 · 쉼표로 구분 (예: 강렬, 명확, 구조)">
      <textarea class="af-in rs-desc" rows="2" data-code="${code}" data-f="desc" placeholder="이 코어에 대한 설명">${esc(v.desc||'')}</textarea>
    </div>`;
  }).join('');
  box.querySelectorAll('[data-f]').forEach(el=>{
    const handler=()=>{
      const code=el.dataset.code, f=el.dataset.f;
      const v=results[code]=results[code]||{code,order:codes.indexOf(code)};
      v.code=code;
      if(f==='keywords')v.keywords=el.value.split(',').map(x=>x.trim()).filter(Boolean).slice(0,4);
      else v[f]=el.value;
      const row=el.closest('.rs-row'); if(row)row.classList.toggle('rs-empty',!(v.name&&v.desc));
      markDirty(); updateTabCounts();
    };
    el.addEventListener(el.tagName==='TEXTAREA'?'input':'input',handler);
  });
  box.querySelectorAll('.rs-copy').forEach(b=>b.onclick=()=>{
    const url=shareUrlFor(b.dataset.code);
    navigator.clipboard?.writeText(url).then(()=>toast(`${b.dataset.code} 링크를 복사했어요`)).catch(()=>toast(url));
  });
}
$('rsCopyAll')&&($('rsCopyAll').onclick=()=>{
  const lines=allCoreCodes().map(c=>{
    const v=(MBCI.results||{})[c];
    return `${c}${v&&v.name?' · '+v.name:''}\t${shareUrlFor(c)}`;
  }).join('\n');
  navigator.clipboard?.writeText(lines).then(()=>toast('16개 결과 링크를 전부 복사했어요')).catch(()=>toast('복사에 실패했어요'));
});

function renderAdminMbci(){
  const qs=MBCI.questions.slice().sort((a,b)=>a.order-b.order);
  if(!mqSel||!MBCI.questions.find(q=>q.id===mqSel))mqSel=qs[0]&&qs[0].id;
  $('mqNeutral').checked=(MBCI.settings||{}).neutralEnabled!==false;
  $('mqNeutralLabel').value=(MBCI.settings||{}).neutralLabel||'';
  $('mqList').innerHTML=qs.map((q,i)=>`<div class="mq-row${q.id===mqSel?' on':''}${q.active===false?' off':''}" data-q="${q.id}">
      <div class="mq-r-top"><b>${i+1}. ${esc(q.id)}</b><span class="mq-ax">${esc(q.axisId)}</span>
        <span class="mq-pts">A ${esc(q.answers[0].pole)}+${q.answers[0].weight} · B ${esc(q.answers[1].pole)}+${q.answers[1].weight}</span></div>
      <div class="mq-r-txt">${esc(q.text)}</div>
      <div class="mq-r-acts">
        <label class="mq-chk" onclick="event.stopPropagation()"><input type="checkbox" data-act="${q.id}" ${q.active!==false?'checked':''}> 사용</label>
        <button type="button" data-mv="${q.id}:-1" ${i===0?'disabled':''} title="위로">↑</button>
        <button type="button" data-mv="${q.id}:1" ${i===qs.length-1?'disabled':''} title="아래로">↓</button>
      </div></div>`).join('');
  $('mqList').querySelectorAll('.mq-row').forEach(r=>r.onclick=e=>{
    if(e.target.closest('button,input,label'))return;
    if(mqDraft&&mqDirty()&&!confirm('적용하지 않은 편집이 있습니다. 버리고 다른 문항으로 이동할까요?'))return;
    mqSel=r.dataset.q; mqDraft=null; renderAdminMbci();
  });
  $('mqList').querySelectorAll('[data-act]').forEach(cb=>cb.onchange=()=>{
    const q=MBCI.questions.find(x=>x.id===cb.dataset.act); q.active=cb.checked;
    const v=validateMbci();
    if(v.errors.some(x=>x.includes('활성 문항이 없음'))){q.active=!cb.checked;cb.checked=!cb.checked;alert('이 문항을 끄면 해당 축에 활성 문항이 하나도 남지 않습니다. 끌 수 없습니다.');return;}
    markDirty(); renderAdminMbci();
  });
  $('mqList').querySelectorAll('[data-mv]').forEach(b=>b.onclick=()=>{
    const [id,d]=b.dataset.mv.split(':'); const arr=MBCI.questions.slice().sort((a,b)=>a.order-b.order);
    const i=arr.findIndex(q=>q.id===id), j=i+(+d); if(j<0||j>=arr.length)return;
    [arr[i],arr[j]]=[arr[j],arr[i]]; arr.forEach((q,k)=>q.order=k+1);
    markDirty(); renderAdminMbci();
  });
  $('panelMbci').querySelectorAll('[data-vw]').forEach(b=>b.onclick=()=>{mqVw=b.dataset.vw;
    $('panelMbci').querySelectorAll('[data-vw]').forEach(x=>x.classList.toggle('on',x===b));renderMqPreview();});
  if(!mqDraft){const q=MBCI.questions.find(x=>x.id===mqSel); mqDraft=q?JSON.parse(JSON.stringify(q)):null;}
  renderMqForm(); renderMqPreview(); renderMqSim(); renderMbciCheck();
}
function mqDirty(){const q=MBCI.questions.find(x=>x.id===mqSel);return q&&JSON.stringify(q)!==JSON.stringify(mqDraft);}
function mqSetting(){
  MBCI.settings=MBCI.settings||{};
  MBCI.settings.neutralEnabled=$('mqNeutral').checked;
  MBCI.settings.neutralLabel=$('mqNeutralLabel').value.trim()||'둘 다 애매해요';
  markDirty(); renderMqPreview();
}
function renderMqForm(){
  const q=mqDraft, box=$('mqForm'); if(!q){box.innerHTML='';return;}
  const ax=mbciAxis(q.axisId)||MBCI.axes[0];
  const poleOpts=an=>[ax.left,ax.right].map(p=>`<option value="${p.code}" ${an.pole===p.code?'selected':''}>${p.code} · ${esc(p.label)}</option>`).join('');
  const ansForm=an=>{const im=an.image||(an.image={src:'',alt:'',fit:'contain',position:'center',sourceNote:''});
    return `<div class="mq-ans">
      <div class="mq-ans-h">답변 ${an.id}</div>
      <label class="af-l">답변 문구</label><textarea class="af-in" rows="2" data-f="text" data-a="${an.id}">${esc(an.text)}</textarea>
      <div class="mq-grid2">
        <div><label class="af-l">점수 극</label><select class="af-in" data-f="pole" data-a="${an.id}">${poleOpts(an)}</select></div>
        <div><label class="af-l">가중치 <em>0–3</em></label><input class="af-in" type="number" min="0" max="3" step="1" data-f="weight" data-a="${an.id}" value="${an.weight}"></div>
      </div>
      <div class="mq-imgbox">
        <div class="mb-img mq-thumb"><img src="${esc(im.src||Q_PLACEHOLDER)}" alt="" style="object-fit:${im.fit==='cover'?'cover':'contain'};object-position:${esc(im.position||'center')}"></div>
        <div class="mq-imgctl">
          <div class="mq-btnrow"><button type="button" class="chip-btn" data-up="${an.id}">파일 업로드</button>
            <button type="button" class="chip-btn" data-url="${an.id}">URL</button>
            ${im.src?`<button type="button" class="chip-btn" data-rm="${an.id}">이미지 제거</button>`:''}</div>
          <label class="af-l">대체 텍스트(alt)</label><input class="af-in" data-f="image.alt" data-a="${an.id}" value="${esc(im.alt||'')}" placeholder="이미지가 보여주는 내용을 짧게">
          <div class="mq-grid2">
            <div><label class="af-l">표시 방식</label><select class="af-in" data-f="image.fit" data-a="${an.id}">
              <option value="contain" ${im.fit!=='cover'?'selected':''}>contain · 잘림 없음</option><option value="cover" ${im.fit==='cover'?'selected':''}>cover · 꽉 채움</option></select></div>
            <div><label class="af-l">초점 위치</label><select class="af-in" data-f="image.position" data-a="${an.id}">
              ${['center','top','bottom','left','right'].map(p=>`<option ${im.position===p?'selected':''}>${p}</option>`).join('')}</select></div>
          </div>
          <label class="af-l">출처·라이선스 메모</label><input class="af-in" data-f="image.sourceNote" data-a="${an.id}" value="${esc(im.sourceNote||'')}" placeholder="예: 자체 제작 예시">
        </div>
      </div></div>`;};
  box.innerHTML=`<div class="mq-form-h"><b>${esc(q.id)}</b><span>문항 ID는 내부 식별자라 변경하지 않습니다</span></div>
    <label class="af-l">질문 문구</label><textarea class="af-in" rows="2" data-f="text">${esc(q.text)}</textarea>
    <div class="mq-grid2">
      <div><label class="af-l">축</label><select class="af-in" data-f="axisId">${mbciAxes().map(a=>`<option value="${a.id}" ${q.axisId===a.id?'selected':''}>${a.id} · ${esc(a.name)}</option>`).join('')}</select></div>
      <div><label class="af-l">내부 운영 메모</label><input class="af-in" data-f="memo" value="${esc(q.memo||'')}"></div>
    </div>
    <div class="mq-anss">${q.answers.map(ansForm).join('')}</div>
    <div class="mq-form-acts"><span id="mqFormMsg"></span>
      <button type="button" class="chip-btn" id="mqRevert">되돌리기</button>
      <button type="button" class="chip-btn solid" id="mqApply">이 문항 적용</button></div>
    <input type="file" id="mqFile" accept="image/webp,image/png,image/jpeg" hidden>`;
  box.querySelectorAll('[data-f]').forEach(el=>el[el.tagName==='SELECT'?'onchange':'oninput']=()=>{
    const tgt=el.dataset.a?q.answers.find(x=>x.id===el.dataset.a):q;
    const path=el.dataset.f.split('.');
    let o=tgt; while(path.length>1)o=o[path.shift()];
    o[path[0]]=el.dataset.f==='weight'?(el.value===''?NaN:+el.value):el.value;
    if(el.dataset.f==='axisId'){ // 축을 바꾸면 극을 새 축의 좌/우로 다시 맞춘다
      const na=mbciAxis(q.axisId); q.answers[0].pole=na.left.code; q.answers[1].pole=na.right.code; renderMqForm();
    }
    renderMqPreview(); mqFormMsg();
  });
  let upFor=null;
  box.querySelectorAll('[data-up]').forEach(b=>b.onclick=()=>{upFor=b.dataset.up;$('mqFile').click();});
  $('mqFile').onchange=e=>{
    const f=e.target.files[0]; e.target.value=''; if(!f||!upFor)return;
    if(!MQ_TYPES.includes(f.type)){alert('WebP · PNG · JPEG 이미지만 올릴 수 있습니다.');return;}
    if(f.size>MQ_MAX_BYTES){alert(`파일이 너무 큽니다 (${(f.size/1048576).toFixed(1)}MB). 5MB 이하로 올려 주세요.`);return;}
    if(f.size>MQ_WARN_BYTES)toast(`권장 용량(500KB)보다 커요 — ${Math.round(f.size/1024)}KB`);
    const r=new FileReader(); r.onload=()=>{const an=q.answers.find(x=>x.id===upFor); an.image.src=r.result;
      if(!an.image.sourceNote)an.image.sourceNote=f.name; renderMqForm(); renderMqPreview(); mqFormMsg();}; r.readAsDataURL(f);
  };
  box.querySelectorAll('[data-url]').forEach(b=>b.onclick=()=>{
    const u=prompt('이미지 주소를 입력하세요\n(외부 주소는 내보내기·캔버스에서 문제가 생길 수 있어 로컬 파일을 권장합니다)','assets/img/questions/'+q.id+'/'+b.dataset.url.toLowerCase()+'.webp');
    if(u===null)return; q.answers.find(x=>x.id===b.dataset.url).image.src=u.trim(); renderMqForm(); renderMqPreview(); mqFormMsg();
  });
  box.querySelectorAll('[data-rm]').forEach(b=>b.onclick=()=>{q.answers.find(x=>x.id===b.dataset.rm).image.src='';renderMqForm();renderMqPreview();mqFormMsg();});
  $('mqRevert').onclick=()=>{mqDraft=null;renderAdminMbci();};
  $('mqApply').onclick=mqApply;
  mqFormMsg();
}
function mqFormMsg(){const m=$('mqFormMsg'); if(m)m.textContent=mqDirty()?'● 적용하지 않은 편집이 있어요':'';}
function mqApply(){
  // 이 문항을 반영한 상태로 전체 검증 — 오류가 있으면 적용하지 않는다
  const trial=JSON.parse(JSON.stringify(MBCI));
  const i=trial.questions.findIndex(x=>x.id===mqDraft.id); trial.questions[i]=JSON.parse(JSON.stringify(mqDraft));
  const v=validateMbci(trial), mine=v.errors.filter(x=>x.startsWith(mqDraft.id));
  if(mine.length){alert('적용할 수 없습니다:\n\n'+mine.join('\n'));return;}
  const alt=v.warnings.filter(x=>x.startsWith(mqDraft.id)&&x.includes('alt'));
  if(alt.length&&!confirm('대체 텍스트(alt)가 비어 있습니다. 그대로 적용할까요?\n\n'+alt.join('\n')))return;
  const idx=MBCI.questions.findIndex(x=>x.id===mqDraft.id);
  MBCI.questions[idx]=JSON.parse(JSON.stringify(mqDraft));
  markDirty(); mqDraft=null; renderAdminMbci(); toast(`${MBCI.questions[idx].id} 적용 — 「데이터 파일 내보내기」로 영구 반영하세요`);
}
function renderMqPreview(){
  const box=$('mqPreview'); if(!box||!mqDraft)return;
  const qs=mbciQs(), idx=Math.max(0,qs.findIndex(x=>x.id===mqDraft.id));
  const st=MBCI.settings||{};
  box.className='mq-preview'+(mqVw==='m'?' mobile':'');
  box.innerHTML=`<div class="mq-pv-frame"><div id="qWrapPv">${mbciQuestionHTML(mqDraft,idx,qs.length||1,null)}
    ${st.neutralEnabled!==false?`<button type="button" class="opt opt-skip mb-neutral">${esc(st.neutralLabel||'둘 다 애매해요')}</button>`:''}</div></div>`;
  box.querySelectorAll('.mb-opt').forEach(b=>b.onclick=()=>{box.querySelectorAll('.mb-opt').forEach(x=>x.classList.toggle('on',x===b));});
}
function renderMqSim(){
  const box=$('mqSim'); if(!box)return;
  const qs=mbciQs();
  const r=scoreMbci(mqSimAns,qs);
  const line=mbciAxes().map(a=>`${a.left.code} ${r.scores[a.left.code]||0} / ${a.right.code} ${r.scores[a.right.code]||0}`).join(' · ');
  const code=r.resultCode||mbciAxes().map(a=>r.axisResult[a.id]||'?').join('');
  box.innerHTML=`<div class="mq-sim-bar"><button type="button" class="chip-btn" data-all="A">모두 A</button><button type="button" class="chip-btn" data-all="B">모두 B</button><button type="button" class="chip-btn" data-all="">초기화</button>
      <span class="mq-sim-res">${line} → <b>${esc(code)}</b>${r.ties.length?` <em>(미정: ${r.ties.join(', ')})</em>`:''}</span></div>
    <div class="mq-sim-rows">${qs.map((q,i)=>`<div class="mq-sim-row"><span>${i+1}. ${esc(q.axisId)}</span><span class="mq-sim-q">${esc(q.text)}</span>
      <span class="mq-seg">${['A','B','N'].map(k=>`<button type="button" data-sq="${q.id}:${k}" class="${mqSimAns[q.id]===k?'on':''}">${k==='N'?'중립':k}</button>`).join('')}</span></div>`).join('')}</div>`;
  box.querySelectorAll('[data-sq]').forEach(b=>b.onclick=()=>{const [id,k]=b.dataset.sq.split(':');mqSimAns[id]=mqSimAns[id]===k?undefined:k;renderMqSim();});
  box.querySelectorAll('[data-all]').forEach(b=>b.onclick=()=>{const k=b.dataset.all;mqSimAns={};if(k)qs.forEach(q=>mqSimAns[q.id]=k);renderMqSim();});
}
...
/* ================= 16 MAP ================= */
function buildMap(){
  const g=$('grid16'); if(!g)return;   // v2.1.0: 16유형 지도(mapSec)가 삭제되어 더 이상 없다
  g.innerHTML='';
...
/* ================= NAV ================= */
/* v2.1.0: 직접 조절하기가 사라지면서 모드 전환 자체가 없어졌다 — 시작 버튼 하나만 남는다 */
function showApp(){$('intro').classList.add('hidden');$('app').classList.add('on');window.scrollTo(0,0);}
$('modeQ').onclick=()=>{brandName=($('brandNameInput').value||'').trim();showApp();resetQ();renderQ();
  const box=$('result'); if(box)box.innerHTML=`<div class="placeholder"><div class="big">12개의 질문에 답하면 브랜드 코어가 나타납니다</div><p>왼쪽에서 테스트를 진행해 주세요. 네 개의 축이 모두 정해지면 이름과 설명이 함께 표시됩니다.</p></div>`;};
...
function exitAdminMode(){
  ...
  document.body.style.overflow='';
  document.title='MBCI — Markinfo Brand Core Indicator';
...
function goHome(){
  ...
  resetAllState();
  document.body.classList.remove('mbci-mode');
...
function markDirty(){adminDirty=true;const b=$('adSaveBtn');if(b&&!b.classList.contains('dirty')){b.classList.add('dirty');b.textContent='● 데이터 파일 내보내기';}scheduleDraftSave();}
function clearDirty(){adminDirty=false;const b=$('adSaveBtn');if(b){b.classList.remove('dirty');b.textContent='데이터 파일 내보내기';}clearDraft();}

/* ================= v2.1.0 관리자 임시저장 =================
   수정 중 실수로 새로고침해도 잃지 않도록, 편집할 때마다(디바운스) 세션에 임시 저장한다.
   내보내기(파일·zip)를 하면 임시본은 지운다 — 내보낸 파일이 곧 "확정본"이라는 뜻이다.
   브라우저를 완전히 닫으면(세션 종료) 임시본도 함께 사라진다 — 내보내기만이 영구 저장이다. */
const DRAFT_KEY='mbciAdminDraft.v1';
...
function saveDraftNow(){
  try{
    const obj=currentDataObject();
    sessionStorage.setItem(DRAFT_KEY, JSON.stringify({savedAt:new Date().toISOString(), data:obj}));
    const el=$('draftStatus'); if(el)el.textContent='임시 저장됨 · '+new Date().toLocaleTimeString('ko-KR',{hour:'2-digit',minute:'2-digit'});
  }catch(e){ console.warn('[임시저장 실패]',e); }
}
function clearDraft(){ try{sessionStorage.removeItem(DRAFT_KEY);}catch(e){} const el=$('draftStatus'); if(el)el.textContent=''; }
function checkDraftOnLoad(){
  let raw=null; try{raw=sessionStorage.getItem(DRAFT_KEY);}catch(e){return;}
  if(!raw)return;
  let parsed; try{parsed=JSON.parse(raw);}catch(e){return;}
  if(!parsed||!parsed.data)return;
  const when=parsed.savedAt?new Date(parsed.savedAt).toLocaleString('ko-KR'):'알 수 없음';
  if(!confirm(`내보내지 않은 임시 저장본이 있습니다 (${when} 저장).\n\n이어서 편집할까요?\n\n취소하면 임시 저장본을 지우고 서버의 원본으로 시작합니다.`)){
    clearDraft(); return;
  }
...
/* v2.2.0: 레거시 16코드(GSRM 등) → MBCI 코드(ESTJ 등) 역방향 조회.
   자산(폰트·색상·목업)은 레거시 코드로 그대로 저장돼 있지만, 사람에게 보여줄 코드·이름은 MBCI 기준이다. */
const LEGACY_TO_MBCI={};
Object.entries((MBCI.results||{})).forEach(([mb,info])=>{ if(info.legacyStyleCode)LEGACY_TO_MBCI[info.legacyStyleCode]=mb; });
function mbciCodeFor(legacyCode){ return LEGACY_TO_MBCI[legacyCode]||legacyCode; }
const codeName=c=>{
  const nm=STY16[c]?STY16[c].name:c, mb=LEGACY_TO_MBCI[c];
  return mb?`${nm} (${mb})`:nm;
};
...
function initAdminSelects(){
  ...
  { const keep=sel.value;
    sel.innerHTML=Object.entries(STYLES).map(([c,st])=>`<option value="${c}">${st.adj} (${mbciCodeFor(c)})</option>`).join('');
    sel.value=curCode||keep||Object.keys(STYLES)[0]; }
  const fs=$('fFilterStyle');
  { const keep=fs.value;
    fs.innerHTML='<option value="">전체 16유형</option>'+CODES.map(c=>`<option value="${c}">${codeName(c)}</option>`).join('');
    fs.value=keep||''; }
  ...
  if(isel){
    ...
    isel.innerHTML=Object.entries(STYLES).map(([c,st])=>`<option value="${c}">${st.adj} (${mbciCodeFor(c)})</option>`).join('');
    isel.value=curCode||keep||Object.keys(STYLES)[0];
  }
}
/* v2.0.0: 관리자 접근 비밀번호 — 이 사이트는 서버가 없는 정적 배포이므로
   진짜 보안이 아니라 우연한 진입을 막는 1차 방어선이다(코드를 보면 누구나 알 수 있다).
   같은 탭에서는 한 번 확인하면 다시 묻지 않는다(sessionStorage). */
const ADMIN_PW='prism2026';
function tryEnterAdmin(){
  const clearHash=()=>{if(location.hash==='#admin')history.replaceState(null,'',location.pathname+location.search);};
  let authed=false;
  try{authed=sessionStorage.getItem('mbciAdminAuth')==='1';}catch(e){}
  if(authed){enterAdminMode();return;}
  openPwModal(clearHash);
}
/* v2.1.0: 브라우저 기본 prompt() 대신 화면 중앙에 뜨는 모달로 비밀번호를 받는다 */
function openPwModal(onCancel){
  let m=$('pwModal');
  if(!m){
    m=document.createElement('div'); m.id='pwModal'; m.className='pw-modal';
    m.innerHTML=`<div class="pw-bg"></div>
      <form class="pw-card" id="pwForm" role="dialog" aria-modal="true" aria-label="관리자 비밀번호">
        <div class="pw-title">관리자 비밀번호</div>
        <p class="pw-sub">이 영역은 마크인포 관리자만 접근할 수 있어요.</p>
        <input type="password" id="pwInput" class="pw-input" placeholder="비밀번호" autocomplete="off">
        <div class="pw-err hidden" id="pwErr">비밀번호가 올바르지 않습니다.</div>
        <div class="pw-acts">
          <button type="button" class="chip-btn" id="pwCancel">취소</button>
          <button type="submit" class="chip-btn solid" id="pwOk">확인</button>
        </div>
      </form>`;
    document.body.appendChild(m);
  }
  m.classList.add('on');
  const inp=$('pwInput'), err=$('pwErr');
  inp.value=''; err.classList.add('hidden');
  setTimeout(()=>inp.focus(),30);
  const close=(cancelled)=>{ m.classList.remove('on'); if(cancelled&&onCancel)onCancel(); };
  $('pwCancel').onclick=()=>close(true);
  m.querySelector('.pw-bg').onclick=()=>close(true);
  const esc=e=>{if(e.key==='Escape'){close(true);document.removeEventListener('keydown',esc);}};
  document.addEventListener('keydown',esc);
  $('pwForm').onsubmit=e=>{
    e.preventDefault();
    if(inp.value===ADMIN_PW){
      try{sessionStorage.setItem('mbciAdminAuth','1');}catch(ex){}
...
let draftCheckedThisSession=false;
function enterAdminMode(){
  ...
  document.title='관리자 — MBCI';
  initAdminSelects(); setAdminTab('mbci');
  if(!draftCheckedThisSession){ draftCheckedThisSession=true; checkDraftOnLoad(); }
  window.scrollTo(0,0);
}
...
function setAdminTab(t){
  ...
  [['fonts','panelFonts'],['classify','panelClassify'],['algorithm','panelAlgorithm'],['color','panelColor'],['image','panelImage'],['mockup','panelMockup'],['mbci','panelMbci'],['results','panelResults']]
...
function updateTabCounts(){
  ...
  const rs=MBCI.results||{}, filled=allCoreCodes().filter(c=>rs[c]&&rs[c].name&&rs[c].desc).length;
  const rc=$('tabCntResults'); if(rc)rc.textContent=`${filled}/16`;
}
/* 4개 축이 만드는 16개 코드를 codeOrder 순서로 나열 — 결과 탭·공유 링크의 기준 목록 */
function allCoreCodes(){
  const order=MBCI.codeOrder||mbciAxes().map(a=>a.id);
  const axesByOrder=order.map(id=>mbciAxis(id));
  const out=[];
  const rec=(i,acc)=>{ if(i===axesByOrder.length){out.push(acc);return;}
    const a=axesByOrder[i]; rec(i+1,acc+a.left.code); rec(i+1,acc+a.right.code); };
  rec(0,'');
  return out;
}
/* ---------- 탭1: 폰트 리스트 ---------- */
...
function currentDataObject(){
  return {__meta:{version:APP_VERSION,exportedAt:new Date().toISOString(),
    ...
    FONT_DB,ALGO16,ALGO_META,STY16,STYLES,STYLE_SAMPLES,CLS_SAMPLE,FONTMAP,MOCKUP_IMGS,MBCI_TEST:MBCI};
}
...
function extractDataUris(obj){
  ...
  const put=(uri,dir,stem)=>{
    ...
    n++;
    const path=`${dir||'assets/img/mockups'}/${stem||'upload'}-${Date.now().toString(36)}-${n}.${ext}`;
  ...
  // v0.20.0: MBCI 선택지 이미지 → assets/img/questions/{문항ID}/{답변ID}-{시각}.{확장자}
  ((obj.MBCI_TEST&&obj.MBCI_TEST.questions)||[]).forEach(q=>(q.answers||[]).forEach(an=>{
    if(an.image&&an.image.src&&an.image.src.startsWith('data:'))
      an.image.src=put(an.image.src,`assets/img/questions/${q.id}`,an.id);
  }));
  return files;
}
...
async function exportSiteZip(){
  ...
  // v0.20.0: 사본에서 이미지 경로를 바꾼다 — 원본을 바꾸면 이번 세션에서 아직 서버에 없는 경로를 보게 된다
  ...
  EXIST_IMGS.push('assets/img/brand/markinfo-logo.webp','assets/img/brand/favicon.ico',
    ...
    'assets/img/brand/apple-touch-icon.png','assets/img/og/default.png','assets/img/questions/placeholder.webp');
  MBCI.questions.forEach(q=>q.answers.forEach(an=>{const u=an.image&&an.image.src;
    if(u&&!u.startsWith('data:')&&!/^https?:/i.test(u))EXIST_IMGS.push(u);}));
  ...
  const body='/* MBCI (Markinfo Brand Core Indicator) — 데이터 파일\n'
...
function mbciExportGuard(){
  const v=validateMbci();
  if(v.errors.length){
    alert('MBCI 질문 데이터에 오류가 있어 내보낼 수 없습니다.\n\n'+v.errors.slice(0,8).join('\n')+(v.errors.length>8?`\n…외 ${v.errors.length-8}건`:'')+'\n\n관리자 「MBCI 질문 관리」 탭에서 확인해 주세요.');
    return false;
  }
  return true;
}
...
function importDataFile(inp){
  ...
  r.onload=()=>{
    ...
    try{
      ...
      if(obj.MBCI_TEST!==undefined){
        const me=mbciSchemaErrors(obj.MBCI_TEST);
        if(me.length){alert('MBCI 질문 데이터 형식이 올바르지 않아 불러오지 않았습니다. 현재 데이터는 그대로 유지됩니다.\n\n'+me.slice(0,6).join('\n'));return;}
      }
      ...
      Object.keys(BSM_DATA).forEach(k=>{ if(obj[k]!==undefined)replaceData(k,obj[k]); });
      // v0.19.1: 심각한 버그 수정 — 여기서 location.reload()를 부르면 서버의 정적 파일은
      // 그대로이므로 방금 불러온 내용이 전부 사라지고 예전 데이터로 되돌아간다.
      // 새로고침 없이 화면만 다시 그린다.
      afRepWorking=[];
      mqSel=null; mqDraft=null; mqSimAns={}; resetQ();
      if(obj.MBCI_TEST===undefined)toast('예전 형식 파일이라 MBCI 질문은 현재 값을 유지했어요');
      initAdminSelects();
      if(curCode){curFontIdx=0;renderStyle();}
      if(document.body.classList.contains('admin-mode')){
        if(adminTab==='fonts')renderFontList();
        else if(adminTab==='classify'){clsIdx=Math.min(clsIdx,FONT_DB.length-1);renderClassify();}
        else if(adminTab==='mockup'){amCurId=null;renderAdminMockup();}
        else if(adminTab==='mbci')renderAdminMbci();
        else setAdminTab(adminTab);
      }
      clearDirty();
      toast(`데이터를 불러왔어요 · 글꼴 ${obj.FONT_DB.length}종 · 목업 ${Object.keys(obj.MOCKUP_IMGS).length}개`);
...
/* v2.1.0: 직접 조절하기·16유형 지도 삭제로 초기 렌더는 더 이상 필요 없다.
   buildAxes/buildMap 함수 자체는 관리자의 색상 가이드라인 저장 등에서 안전하게(가드됨) 호출될 수 있어 남겨둔다. */
...
else { tryOpenSharedCore(); }
/* v2.1.0: 관리자 「결과」 탭에서 복사한 공유 링크(#/core/ESTJ)를 직접 열었을 때
   테스트 없이 그 결과를 바로 보여준다. 왼쪽은 안내 카드로 대체하고, 오른쪽은 평소와 같은 결과 패널을 쓴다. */
function tryOpenSharedCore(){
  const m=/^#\/core\/([A-Z]{2,6})$/.exec(location.hash);
  if(!m)return;
  const code=m[1];
  if(!allCoreCodes().includes(code))return;
  showApp();
  const stage=$('qStage'), gauges=$('mbciGauges');
  if(stage)stage.classList.add('hidden');
  if(gauges){
    gauges.classList.remove('hidden');
    gauges.innerHTML=`<div class="mb-g-head"><b>${code}</b><span>공유된 결과 링크예요</span></div>
      <p style="font-size:12.5px;color:var(--ink3);line-height:1.7;margin:4px 0 18px">
        이 링크는 특정 브랜드 코어 결과만 보여줍니다. 축 게이지는 실제로 테스트를 진행해야 확인할 수 있어요.</p>
      <div class="mb-r-acts"><button type="button" class="btn-line" id="mbRetry">나도 테스트하기</button></div>`;
    $('mbRetry').onclick=()=>{resetQ();history.replaceState(null,'',location.pathname+location.search);renderQ();window.scrollTo({top:0,behavior:'smooth'});};
  }
  const order=MBCI.codeOrder||mbciAxes().map(a=>a.id);
  renderBrandCoreResult(code, code);
}
...
window.addEventListener('hashchange',()=>{
  ...
  else tryOpenSharedCore();   // v2.1.0: 같은 탭에서 해시만 바뀌는 경우(새로고침 없이)도 공유 링크가 반영되게
});
